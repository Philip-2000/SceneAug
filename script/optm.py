def parse(): #using pattern to understand scene
    ...
    sceneLst = [
        ...
        #"34f5f040-eb63-482b-82cb-9a3914c92c79_LivingDiningRoom-86782024",
        "0c26f793-846f-417a-b27e-0fbbdc3db601_SecondBedroom-10372",
    ]

    from SceneClasses.Operation.Optm import default_optm_config as config
    #edit the config #"res":{"res":(.5,.5,.5),},  
    #config["phy"]["vis"], config["pat"]["vis"] = {"fiv":{"wo":(1.0,0,0),"wi":(0,0,1.0), "dr":(0,1.0,0),}, "ob":(0.33,0.33,0.33) }, {}#{"pat":True}
    #config["phy"]["vis"]["fiv"] = { "dr":(0,1.0,0), "ob":(0.33,0.33,0.33) } #"wo":(1.0,0,0),"wi":(0,0,1.0),
    #config["phy"]["grid"] = {"L":4.0,"d":0.1,"b":10}
    #config["adjs"] = {"decay":200.0,'inertia':0.0}
    config["pat"]["rate"]["r0"] = 0.7
    config["phy"]["wall"]["bound"] = 0.9
    #config["pat"]["prerec"] = False
    #config["phy"]["s4"] = 4
